...
?>
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Data Keanekaragaman Hayati</h4>
                                    ...
                                    <table id="dataTable3" class="text-left">
                                        ...
                                        <tbody>
                                          <?php
                                              ...
                                              $sql=mysqli_query($conn,"SELECT * FROM tb_inventaris where bidang = 'Keanekaragaman Hayati'");
                                          ...
                                          ?>
                                              <tr>
                                                ...
                                                <td>
                                                  ...
                                                  <a href='?p=kh&del=<?= $data["id_inven"]; ?>'><i class="ti-trash"></i> </a>
                                                </td>
                                                <?php endif; ?>
                                              </tr>
                                              <?php endwhile ?>
